...
<TABLE WIDTH="100%" BORDER="0" CELLSPACING="0" CELLPADDING="5">
		...
		<A HREF="virt_server_group_edit_group.php<?php if (!empty($selected_host)) { echo "?selected_host=$selected_host"; } ?> " CLASS="tabon" NAME="VIRT server group">VIRTUAL SERVER GROUP</A>
		&nbsp;|&nbsp;

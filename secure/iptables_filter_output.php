...
<TABLE WIDTH="100%" BORDER="0" CELLSPACING="0" CELLPADDING="5">
        <TR>
                <TD>&nbsp;<BR><FONT SIZE="+2" COLOR="#CC0000">FILTER OUTPUT</FONT><BR>&nbsp;</TD>
        </TR>
</TABLE>
...
<?php
	...
	if ($iptables_service == "ADD") { 
		...
		$ipt->appendRule("filter", "OUTPUT", $ruleA);
	...
	if ($iptables_service == "DELETE" ) {
		...
		echo "</TD></TR></TABLE><TABLE WIDTH=\"100%\" BORDER=\"0\" CELLSPACING=\"1\" CELLPADDING=\"5\"><TR><TD BGCOLOR=\"ffffff\"><HR><H2><FONT COLOR=\"#cc0000\" CLASS=\"title\">Click <A HREF=\"iptables_filter_output.php\" NAME=\"iptables\">HERE</A> for refresh</FONT></H2><HR></TD></TR></TABLE>";
		$ipt->removeRule("filter", "OUTPUT", $selected_host);
		$ipt->applyNow(false, NULL, $rules_file);
		exit;
	}
...
<FORM METHOD="POST" ENCTYPE="application/x-www-form-urlencoded" ACTION="iptables_filter_output.php">

...
Source8: naxsi_core.rules 
Source9: naxsi_learning.rules 
...
./configure \
        ...
        --add-module=%{_builddir}/naxsi/naxsi_src \
...
%{__install} -m 644 -p %{SOURCE9} \
   $RPM_BUILD_ROOT%{_sysconfdir}/nginx/naxsi_learning.rules
...
%config(noreplace) %{_sysconfdir}/nginx/naxsi_learning.rules
...
%{_sysconfdir}/nginx/browsers
%{_sysconfdir}/nginx/module_stubs
%{_sysconfdir}/nginx/sbin/dso_tool
...
%changelog
* Tue Dec 09 2014 Vincent Li <vincent.mc.li@gmail.com>
- add naxsi for WAF

* Tue Nov 06 2014 Vincent Li <vincent.mc.li@gmail.com>
- tengine
- 2.0.3
- adopted to tengine 2.0.3 
- include tengine dso /etc/nginx/include/*.h files in %file 
